...
public class ThirdMenuContents extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thirdmenucontents);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            target = "http://175.121.166.150:8000/capston/application/frappeList.php"; //해당 웹서버에 접속할 수 있게
        }
        ...
        public void onPostExecute(String result) {//결과값 result로 받아오기
            try {
                ...
                JSONArray jsonArray = jsonObject.getJSONArray("menufrappe");
                int count = 0;
