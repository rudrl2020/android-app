...
public class Order_Menu_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button btn_add = (Button) findViewById(R.id.btn_addCart);
        lv_orderMenu = (ListView)findViewById(R.id.lv_orderMenu);
        order_menuList = new ArrayList<Order_Menu>();
        adapter = new Order_Menu_Adapter(getApplicationContext(), order_menuList, userPhone);
